...
class CLS_Button(object):
    def __init__(self, img, pressed_img, posX, posY, showStat, w, h):
        self.img = img
...
class FW_Main(object):
    ...
    def __init__(self):
        ...
        self.spin_button_1 = CLS_Button(self.spin_button_pic, self.spin_button_pressed_pic, SCREEN_W - 3 * self.spinner_r - 20 - self.spin_button_w // 2, 30 + 2 * self.spinner_r, 1, self.spin_button_w, self.spin_button_h)
        self.spin_button_2 = CLS_Button(self.spin_button_pic, self.spin_button_pressed_pic, SCREEN_W - self.spinner_r - 10 - self.spin_button_w // 2, 30 + 2 * self.spinner_r, 1, self.spin_button_w, self.spin_button_h)
        self.end_turn_button = CLS_Button(self.end_turn_button_pic, self.end_turn_button_pressed_pic, SCREEN_W - 2 * self.spinner_r - 15 - self.end_turn_button_w // 2, 50 + self.spin_button_h + 2 * self.spinner_r, 1, self.end_turn_button_w, self.end_turn_button_h)
