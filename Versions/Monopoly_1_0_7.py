...
class CLS_Board(object):
    def __init__(self, size, countries, prices, colors):
        ...
        self.infoDic = {'country': [1, -1, (40, 5, 77), -1, -1, -1, -1], 'start': [2, (67, 125, 85), (103, 150, 111), 'START', -1, -1, (255, 255, 255)], \
                        ...
                        'water company': [1, (60, 55, 120), (185, 194, 220), 'W. Company', 124, -1, -1], 'oil company': [1, (110, 75, 60), (225, 210, 188), 'O. Company', 114, -1, -1], \
                        'electric company': [1, (110, 110, 80), (230, 230, 200), 'E. Company', 144, -1, -1], 'casino': [2, (110, 50, 50), (230, 180, 180), 'CASINO', -1, -1, (110, 50, 50)]}
