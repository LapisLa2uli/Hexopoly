...
class CLS_Cell(object):
    ...
    def draw(self, scr):
        if self.stType == 1:
            ...
            if self.img != -1:
                scr.blit(self.img, (self.x - self.img.get_width() // 2, self.y - self.cSize // 3 - self.img.get_height() // 2))
...
class CLS_Board(object):
    ...
    def __init__(self, size, countries, prices, colors):
        ...
        self.casino_pic = pygame.image.load('casino_pic.png')
        ...
        self.treasure_pic = pygame.image.load('treasure_pic.png')
        ...
        self.surprise_pic = pygame.image.load('surprise_pic.png')
        ...
        self.punishment_pic = pygame.image.load('punishment_pic.png')
        ...
        self.infoDic = {'country': [1, -1, (40, 5, 77), -1, -1, -1, -1], 'start': [2, (67, 125, 85), (103, 150, 111), 'START', -1, -1, (255, 255, 255)], \
                        'jail': [2, (30, 30, 30), (170, 170, 170), 'JAIL', -1, self.jail_pic, (30, 30, 30)], 'surprise': [2, (150, 100, 54), (210, 190, 170), 'Surprise!', -1, self.surprise_pic, (150, 100, 54)], \
                        'punishment': [2, (0, 0, 0), (190, 190, 190), 'Punishment', -1, self.punishment_pic, (0, 0, 0)], 'treasure': [2, (110, 75, 40), (230, 209, 200), 'Treasure', -1, self.treasure_pic, (110, 75, 40)], \
                        'water company': [1, (60, 55, 120), (185, 194, 220), 'Water Co.', 124, self.water_pic, -1], 'oil company': [1, (110, 75, 60), (225, 210, 188), 'Oil Co.', 114, self.oil_pic, -1], \
                        'electric company': [1, (110, 100, 80), (230, 220, 200), 'Electric Co.', 144, self.elec_pic, -1], 'casino': [2, (110, 50, 50), (230, 180, 180), 'CASINO', -1, self.casino_pic, (110, 50, 50)], \
        ...
        for i in range(self.cellNum):
            ...
            if type(info) == type([114, 124]):
                newCell = CLS_Cell(self.cX, self.cY, self.cSize, 'country', self.countries[info[0]][info[1]], self.prices[info[0]][info[1]], self.colors[info[0]], self.infoDic['country'][2], 1, self.flags[info[0]][info[1]], -1)
            else:
